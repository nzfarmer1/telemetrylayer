...
class agRelayFeatureDialog(tlFeatureDialog):
    """
    ...
    def __init__(self, dialog, tLayer, feature):
        ...
        try:
            ...
            super(agRelayFeatureDialog, self).__init__(dialog, tLayer, feature, widgets)
            Log.debug(e)
            return
            pass
        ...
        if len(params) >0:
            widgets.append(agRelayFeatureDialog._createTab(Tabs, agTabs.configTab))
        ...
        try:
            ...
            Log.debug("Error setting up feature dialog " +str(e))
