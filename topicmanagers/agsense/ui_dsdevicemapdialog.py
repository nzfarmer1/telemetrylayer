...
#
# Created: Tue Dec  9 08:32:04 2014
...
class Ui_dsDeviceMapDialog(object):
    def setupUi(self, dsDeviceMapDialog):
        ...
        self.nameLabel.setGeometry(QtCore.QRect(30, 74, 41, 16))
        ...
        self.closeButton = QtGui.QPushButton(dsDeviceMapDialog)
        self.closeButton.setGeometry(QtCore.QRect(50, 310, 101, 32))
        ...
        self.topicLabel.setGeometry(QtCore.QRect(30, 102, 41, 20))
        self.topicLabel.setObjectName(_fromUtf8("topicLabel"))
        self.helpText = QtGui.QLabel(dsDeviceMapDialog)
        self.helpText.setGeometry(QtCore.QRect(30, 50, 211, 16))
        ...
        self.parameterTable.setGeometry(QtCore.QRect(30, 186, 251, 121))
        ...
        self.deviceKeyLabel = QtGui.QTextEdit(dsDeviceMapDialog)
        self.deviceKeyLabel.setGeometry(QtCore.QRect(30, 12, 251, 31))
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.deviceKeyLabel.sizePolicy().hasHeightForWidth())
        self.deviceKeyLabel.setSizePolicy(sizePolicy)
        self.deviceKeyLabel.setUndoRedoEnabled(False)
        self.deviceKeyLabel.setReadOnly(True)
        self.deviceKeyLabel.setAcceptRichText(False)
    ...
    def retranslateUi(self, dsDeviceMapDialog):
        ...
        self.closeButton.setText(_translate("dsDeviceMapDialog", "Close", None))
