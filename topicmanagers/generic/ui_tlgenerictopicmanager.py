...
#
# Created: Mon May  4 20:29:50 2015
...
class Ui_tlGenericTopicManager(object):
    ...
    def retranslateUi(self, tlGenericTopicManager):
        ...
        self.plainTextEdit.setPlainText(_translate("tlGenericTopicManager", "This topic manager provides a list of MQTT $SYS topics and a set of default format functions for these.\n"
"", None))
